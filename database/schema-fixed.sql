-- ============================================================================
-- AI Agent UI - Database Schema (FIXED VERSION)
...
-- Admin access - check directly against auth.jwt()
...
create policy "Service role can manage registration requests" on public.registration_requests
  for all using (auth.jwt() ->> 'role' = 'service_role');
...
create policy "Service role can manage permissions" on public.user_permissions
  for all using (auth.jwt() ->> 'role' = 'service_role');
